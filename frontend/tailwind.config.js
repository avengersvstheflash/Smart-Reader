    ...
    extend: {
      ...
      keyframes: {
        ...
        'button-glow': {
          ...
          '100%': { boxShadow: '0 0 0 8px rgb(var(--brand) / 0)' },
        },
      },
      animation: {
        ...
        'line-stream': 'line-stream 0.5s ease-out forwards',
        'check-cascade': 'check-cascade 0.3s ease-out forwards',
        'button-glow': 'button-glow 0.6s ease-out forwards',
      },
    },
  },
  plugins: [typography],
